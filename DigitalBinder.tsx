    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-royal-900/80 backdrop-blur-sm">
      <div className="bg-white rounded-2xl shadow-2xl w-full max-w-4xl max-h-[90vh] overflow-hidden flex flex-col animate-in fade-in zoom-in duration-200">
        <div className="bg-royal-800 p-6 flex justify-between items-center text-white shrink-0">
          ...
          <button onClick={onClose} aria-label="Close" title="Close" className="p-2 hover:bg-royal-700 rounded-full transition-colors focus-visible:ring-2 focus-visible:outline-none focus-visible:ring-white">
            <X size={24} />
          </button>
        </div>
        ...
        <div className="fixed inset-0 z-50 flex justify-end">
          ...
          <div className="relative w-full max-w-md bg-white h-full shadow-2xl p-8 overflow-y-auto animate-in slide-in-from-right duration-300 flex flex-col">
            <div className="flex justify-between items-center mb-6 shrink-0">
              ...
              <button onClick={() => setShowAuditLog(false)} aria-label="Close Audit Log" title="Close Audit Log" className="p-2 hover:bg-slate-100 rounded-full focus-visible:ring-2 focus-visible:outline-none focus-visible:ring-royal-500">
                <X size={24} />
              </button>
            </div>
        ...
        <div className="fixed inset-0 z-50 flex justify-end">
          ...
          <div className="relative w-full max-w-md bg-white h-full shadow-2xl p-8 overflow-y-auto animate-in slide-in-from-right duration-300">
            <div className="flex justify-between items-center mb-8">
              ...
              <button onClick={() => setShowGlossary(false)} aria-label="Close Glossary" title="Close Glossary" className="p-2 hover:bg-slate-100 rounded-full focus-visible:ring-2 focus-visible:outline-none focus-visible:ring-royal-500">
                <X size={24} />
              </button>
            </div>
            <div className="space-y-6">
