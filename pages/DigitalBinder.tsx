...
// Extracted the fast-updating LiveClock state into an isolated component
// to prevent massive minute-by-minute re-renders of the heavy DigitalBinder component.
const LiveClock = () => {
