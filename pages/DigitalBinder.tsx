 ...
 * Extracted the ticking clock into its own isolated component to prevent
 * the massive DigitalBinder component from completely re-rendering every second.
 */
const HeaderClock = () => {
  ...
  return (
    <><span className="opacity-40">{time.toLocaleDateString()}</span><span className="text-white font-black">{time.toLocaleTimeString()}</span></>
  );
};
