      ...
      <div className="bg-white p-10 rounded-xl shadow-lg w-full max-w-sm">
        ...
        <form onSubmit={(e) => { e.preventDefault(); handleLogin(); }}>
          <div className="mb-4 text-left">
            <label htmlFor="username" className="block text-sm font-medium text-slate-700 mb-1">Username <span className="text-red-500">*</span></label>
            <input 
              id="username"
              type="text" 
          ...
          >
            {isLoading ? <><Loader2 className="animate-spin" size={20} /> Logging in...</> : 'Log In'}
          </button>
        </form>
