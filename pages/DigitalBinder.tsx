        ...
        <div className="flex gap-2">
           {domains.map(d => (
             <button 
               ...
               className={`p-3 rounded-2xl transition-all focus-visible:ring-2 focus-visible:outline-none focus-visible:ring-royal-900 ${activeDomain === d.id ? 'bg-royal-900 text-white shadow-lg' : 'bg-slate-50 text-slate-400 hover:bg-slate-100'}`}
             >
               {d.icon}
             </button>
           ))}
