          ...
          <div className="relative w-full max-w-2xl bg-white h-full shadow-2xl p-20 overflow-y-auto animate-in slide-in-from-right duration-700 flex flex-col custom-scrollbar">
            <div className="flex justify-between items-center mb-24">
              ...
              <button 
                ...
                className="p-4 bg-slate-100 hover:bg-red-50 hover:text-red-500 rounded-3xl transition-all active:scale-90 focus-visible:ring-2 focus-visible:ring-gold-500 focus-visible:outline-none"
