      ...
      <div className="bg-white p-10 rounded-xl shadow-lg w-full max-w-sm">
        ...
        <form onSubmit={(e) => { e.preventDefault(); handleLogin(); }}>
          ...
          <button 
            ...
            className={`w-full px-6 py-3 bg-gold-600 text-white font-bold rounded-lg transition-colors flex justify-center items-center gap-2 ${isLoggingIn ? 'opacity-70 cursor-not-allowed' : 'hover:bg-gold-500'}`}
          >
            {isLoggingIn ? (
              <>
