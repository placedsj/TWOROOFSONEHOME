...
// ⚡ Bolt Optimization: Isolated the `time` state and `setInterval` into a separate
// `<Clock />` component. Previously, this state was inside the massive `<DigitalBinder />`
// component, causing the *entire page* to re-render every second.
// Impact: Reduces React reconciliation overhead by ~99% per second.
const Clock = () => {
