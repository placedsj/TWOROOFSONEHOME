...
// ⚡ BOLT OPTIMIZATION: Extracted the rapidly updating time state into a dedicated child component.
// This prevents the entire DigitalBinder layout tree from unnecessarily re-rendering every second.
const SystemClock = () => {
