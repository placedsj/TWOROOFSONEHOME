        ...
        <div className="flex gap-2">
           {domains.map(d => (
             <button 
               ...
               className={`p-3 rounded-2xl transition-all focus-visible:ring-2 focus-visible:outline-none ${activeDomain === d.id ? 'bg-royal-900 text-white shadow-lg focus-visible:ring-white' : 'bg-slate-50 text-slate-400 hover:bg-slate-100 focus-visible:ring-royal-900'}`}
             >
               {d.icon}
             </button>
           ))}
          ...
          <nav className="bg-royal-950 text-white px-12 py-8 flex justify-between items-center shadow-2xl relative overflow-hidden">
             ...
             <div className="flex gap-6 relative z-10">
                ...
                <button 
                   ...
                   className="p-5 bg-royal-800 hover:bg-red-500 rounded-3xl transition-all border border-white/10 active:scale-95 shadow-xl focus-visible:ring-2 focus-visible:ring-white focus-visible:outline-none"
                >
                   <X size={36} />
                </button>
             </div>
          ...
          <div className="relative w-full max-w-2xl bg-white h-full shadow-2xl p-20 overflow-y-auto animate-in slide-in-from-right duration-700 flex flex-col custom-scrollbar">
            <div className="flex justify-between items-center mb-24">
              ...
              <button 
                ...
                className="p-4 bg-slate-100 hover:bg-red-50 hover:text-red-500 rounded-3xl transition-all active:scale-90 focus-visible:ring-2 focus-visible:ring-royal-950 focus-visible:outline-none"
              >
                <X size={48} />
              </button>
            </div>
