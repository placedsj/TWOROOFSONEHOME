...
// ⚡ Bolt: Extracted Clock component to prevent full-tree re-renders
// By moving the rapidly updating state (every second) out of the top-level
// DigitalBinder layout component, we drastically reduce unnecessary React
// renders for the entire tree, resulting in better performance.
const Clock = () => {
