...
// ⚡ Bolt: Extracted LiveClock component to isolate the 1-second interval updates.
// Expected Impact: Prevents the massive DigitalBinder component (and its children) from re-rendering every second.
const LiveClock = () => {
