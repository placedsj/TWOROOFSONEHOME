...
// ⚡ Bolt: Extracted fast-updating `time` state into an isolated component.
// This prevents the massive `DigitalBinder` parent component (and all its children)
// from re-rendering every single second.
const LiveClock = () => {
