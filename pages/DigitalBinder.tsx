...
// ⚡ Bolt Optimization: Isolated LiveClock component
// Moving the 1-second interval state into its own component prevents
// the entire massive DigitalBinder component and all its children
// from needlessly re-rendering every single second.
const LiveClock = () => {
