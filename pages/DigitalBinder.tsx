...
// ⚡ Bolt Optimization: Extracted LiveClock to its own component.
// This prevents the massive DigitalBinder parent component from re-rendering
// every single second when the clock updates, isolating the re-render down to just the text.
const LiveClock = () => {
