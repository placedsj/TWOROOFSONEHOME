...
// Extracted fast-updating clock state (1s interval) into this isolated child component.
// This prevents the massive parent `DigitalBinder` component (and all its complex children)
// from re-rendering every single second, significantly improving responsiveness and main thread performance.
const TopBarClock = () => {
