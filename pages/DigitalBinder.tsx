...
// 💡 What: Extracted LiveClock component
// 🎯 Why: Prevents the entire DigitalBinder (and all its complex children) from re-rendering every second.
// 📊 Impact: Significantly reduces React render cycle overhead.
const LiveClock = () => {
