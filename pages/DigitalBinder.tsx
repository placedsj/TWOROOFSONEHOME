...
// What: Extract rapidly changing state into an isolated component
// Why: Prevents the massive top-level DigitalBinder component from re-rendering entirely every 1 second
// Impact: Improves performance by reducing the rendering scope of a complex page to just this specific time widget
const LiveClock = () => {
