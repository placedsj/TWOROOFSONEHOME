...
// Extracted SystemClock into a dedicated component to prevent the rapidly updating
// setInterval state (1000ms) from causing unnecessary full-tree re-renders of the
// top-level DigitalBinder layout component.
const SystemClock = () => {
