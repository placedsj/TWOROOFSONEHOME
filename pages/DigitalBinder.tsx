...
// Extracted fast-updating time state into an isolated LiveClock child component.
// This prevents the massive DigitalBinder parent component from needlessly re-rendering every second.
const LiveClock = () => {
