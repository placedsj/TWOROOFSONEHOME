...
// --- Performance Isolation: LiveClock ---
// Isolates high-frequency state updates (timer) into a dedicated leaf component
// to prevent the massive DigitalBinder parent from re-rendering every second.
const LiveClock = () => {
