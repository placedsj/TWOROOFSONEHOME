    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-royal-900/80 backdrop-blur-sm">
      <div className="bg-white rounded-2xl shadow-2xl w-full max-w-4xl max-h-[90vh] overflow-hidden flex flex-col animate-in fade-in zoom-in duration-200">
        <div className="bg-royal-800 p-6 flex justify-between items-center text-white shrink-0">
          ...
          <button onClick={onClose} aria-label={`Close ${title}`} className="p-2 hover:bg-royal-700 rounded-full transition-colors focus-visible:ring-2 focus-visible:outline-none focus-visible:ring-white">
            <X size={24} />
          </button>
        </div>
        ...
        <div className="fixed inset-0 z-50 flex flex-col bg-slate-100">
          <div className="bg-royal-900 text-white p-4 shadow-lg flex justify-between items-center shrink-0">
             ...
             <div className="flex items-center gap-3">
               ...
               <button onClick={() => setShowReader(false)} aria-label="Close reader" className="p-2 hover:bg-royal-800 rounded-full focus-visible:ring-2 focus-visible:outline-none focus-visible:ring-white">
                 <X size={24} />
               </button>
             </div>
          </div>
