      ...
      <div className="bg-white p-10 rounded-xl shadow-lg w-full max-w-sm">
        ...
        <form onSubmit={(e) => { e.preventDefault(); handleLogin(); }}>
          ...
          <button 
            ...
            className="w-full px-6 py-3 bg-gold-600 text-white font-bold rounded-lg hover:bg-gold-500 focus-visible:ring-2 focus-visible:ring-gold-500 focus-visible:ring-offset-2 transition-colors disabled:opacity-70 disabled:cursor-not-allowed flex items-center justify-center gap-2"
          >
