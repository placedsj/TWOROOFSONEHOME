          ...
          <div className="bg-white border-t border-slate-100 p-10 flex justify-between items-center px-24 shadow-[0_-20px_60px_rgba(0,0,0,0.05)] relative z-20">
             ...
             >
                ...
                <div className="flex flex-col items-start">
                   <span>Previous</span>
                   <span className="text-[8px] text-slate-400 opacity-0 group-hover:opacity-100 transition-opacity normal-case tracking-normal">Press ←</span>
                </div>
             </button>
             ...
             >
                <div className="flex flex-col items-end">
                   <span>Continue</span>
                   <span className="text-[8px] text-royal-400 opacity-0 group-hover:opacity-100 transition-opacity normal-case tracking-normal">Press →</span>
                </div>
