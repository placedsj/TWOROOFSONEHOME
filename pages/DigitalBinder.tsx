      ...
      {showReader && (
        <div className="fixed inset-0 z-[60] flex flex-col bg-white animate-in fade-in slide-in-from-bottom-24 duration-1000">
          <nav className="bg-royal-950 text-white px-12 py-8 flex justify-between items-center shadow-2xl relative overflow-hidden">
             ...
             <div className="flex gap-6 relative z-10">
                ...
                <button 
                   ...
                   aria-label="Close Reader Mode (Esc)"
                   title="Close (Esc)"
                >
                   <X size={36} />
                </button>
          ...
          <div className="bg-white border-t border-slate-100 p-10 flex justify-between items-center px-24 shadow-[0_-20px_60px_rgba(0,0,0,0.05)] relative z-20">
             ...
             >
                <ChevronLeft size={24} className="transition-transform group-hover:-translate-x-2" /> Previous <span className="ml-2 opacity-50 text-[10px] hidden sm:inline">(←)</span>
             </button>
             ...
             >
                <span className="mr-2 opacity-50 text-[10px] hidden sm:inline">(→)</span> Continue <ChevronRight size={24} className="transition-transform group-hover:translate-x-2" />
             </button>
          </div>
        </div>
      )}
