...
// 💡 What: Extracted LiveClock component to manage time state locally.
// 🎯 Why: DigitalBinder is a massive component. Having a setInterval update its state every 1000ms caused the entire component tree to unnecessarily re-render every second.
// 📊 Impact: Prevents massive re-renders, significantly improving UI performance and battery life.
const LiveClock = () => {
