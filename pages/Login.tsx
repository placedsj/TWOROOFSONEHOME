      ...
      <div className="bg-white p-10 rounded-xl shadow-lg w-full max-w-sm">
        ...
        <form onSubmit={(e) => { e.preventDefault(); handleLogin(); }}>
          ...
          <button 
            type="submit" 
            disabled={isLoading}
            className="w-full px-6 py-3 bg-gold-600 text-white font-bold rounded-lg hover:bg-gold-500 transition-colors disabled:opacity-50 flex items-center justify-center gap-2"
          >
            {isLoading ? (
              <>
