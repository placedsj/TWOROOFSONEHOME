...
// What: Extracted fast-updating time state into an isolated LiveClock component.
// Why: Prevents the entire DigitalBinder component from re-rendering every second.
// Impact: Reduces massive re-renders, significantly saving CPU cycles and battery.
const LiveClock = () => {
