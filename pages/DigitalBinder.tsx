...
// ⚡ Bolt: Extracted LiveClock component
// What: The live clock updates every second via setInterval.
// Why: Previously, this state lived in the massive DigitalBinder component,
// causing the entire application to re-render every second.
// Impact: Isolating this state completely eliminates full-page re-renders,
// significantly reducing CPU usage and main thread blocking.
const LiveClock = () => {
